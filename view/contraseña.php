...
<body>
    <?php
        ...
        //$clave=isset($_POST["categoria"])? $_POST["categoria"]:"";
    ?>
                        ...
                        <div class="mb-4 mb-md-5 text-center">
                            <a href="index.html" class="d-block auth-logo">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mt-2">Ingresa la nueva contraseña</p>
                                </div>
                                <form class="custom-form mt-4 pt-2" id="frmAcceso">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group auth-pass-inputgroup">
                                            <input type="text" class="form-control" id="contraseña" name="clavea" placeholder="Ingrese la contraseña" aria-label="Password" aria-describedby="password-addon">
                                            <button class="btn btn-light ms-0" type="button" id="password-addon"><i class="mdi mdi-eye-outline"></i></button>
                                        </div>
                                        <div class="input-group auth-pass-inputgroup">
                                            <input type="text" class="form-control" id="usuario" name="clavea" placeholder="Ingrese el usuario" aria-label="Password" aria-describedby="password-addon">
                                            <button class="btn btn-light ms-0" type="button" id="password-addon"><i class="mdi mdi-eye-outline"></i></button>
                                        </div>
                                    </div>                                            
                                    <div class="mb-3">
                                        <button class="btn btn-primary w-100 waves-effect waves-light" onclick="reemplazarContraseña()" type="button">Cambiar</button>
                                    </div>
                                </form>
                            </div>
    ...
    <script type="text/javascript" src="script/contraseña.js"></script> 
